...
function requireDefinition() {
  const value = providerDefinitionById('kakao-talkdeal');
  if (!value) throw new Error('Kakao TalkDeal provider definition is missing');
  return value;
}
...
export const kakaoTalkDealProvider: MarketProvider = {
  id: definition.id,
