...
test('purchase evaluation stays public-price-first without automatic personalized checkout', () => {
...
test('explicit price and coupon language is price-sensitive but does not auto-request account pricing', () => {
